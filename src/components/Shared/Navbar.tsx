  ...
  return (
    ...
    >
	  ...
	  <div className="flex justify-center">
		<h3 className=" xl:text-[16px] lg:text-[12px] whitespace-nowrap outfit-medium text-concrete hover:text-white transition-colors duration-200 cursor-pointer"><a href="./AplikasiAbsen">Absensi</a></h3>
          </div>
        </div>
